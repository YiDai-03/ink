...
class SentenceRE(nn.Module):
    ...
    def __init__(self, embedding_dim, dropout, tagset_size):
        super(SentenceRE, self).__init__()

        self.pretrained_model_path =  'bert-base-chinese'#!hparams.pretrained_model_path or
    ...
    def forward(self, token_ids, token_type_ids, attention_mask, e1_mask, e2_mask):
        sequence_output, pooled_output = self.bert_model(token_ids, token_type_ids, attention_mask)
